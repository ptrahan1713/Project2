...
public class XandYValue<E>
{
    ...
    /**
     * This method returns the pair of x and y values at the given position.
     * 
     * @param position is the last element in the array.
     * @return the x and y values.
     */
    public E getPoint(int position)
    {
        return listPoint[position];
    }
